...
namespace aspnetmvc_starter.Web.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> ManageLogins(ManageMessageId? message)
        {
            ...
            var otherLogins = AuthenticationManager.GetExternalAuthenticationTypes().Where(auth => userLogins.All(ul => auth.AuthenticationType != ul.LoginProvider)).ToList().AsEnumerable();
